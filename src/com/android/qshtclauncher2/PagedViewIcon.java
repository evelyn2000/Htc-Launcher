...
public class PagedViewIcon extends TextView {
    ...
    public void applyFromApplicationInfo(ItemInfo info, boolean scaleUp,
            PagedViewIcon.PressedCallback cb) {
    	if(info instanceof ApplicationInfo){
    		mIcon = ((ApplicationInfo)info).iconBitmap;
    	} else if(info instanceof ShortcutInfo){
    		mIcon = ((ShortcutInfo)info).getIcon(((LauncherApplication)super.getContext().getApplicationContext()).getIconCache());
    	}
