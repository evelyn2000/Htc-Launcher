...
public class HandleView extends ImageView {
    ...
    public View focusSearch(int direction) {
        ...
        if (newFocus == null && !mLauncher.isAllAppsVisible() && !mLauncher.isAllAppsWidgetVisible()) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN && (mLauncher.isAllAppsVisible() || mLauncher.isAllAppsWidgetVisible())) {
            return false;
        }
